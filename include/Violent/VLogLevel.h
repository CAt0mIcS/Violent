...
namespace At0::Violent
{
	...
	enum class LogLevel
	{
		 ...
		 * These logs should primarily contain information useful for debugging and have no
		 * long-term value.
		 */
		Debug,
		...
		/**
		 * Not used for writing log messages. Specifies that a logging category should not write any
		 * messages.
		 */
		None
	};
